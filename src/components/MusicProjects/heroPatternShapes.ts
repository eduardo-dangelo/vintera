...
export const HERO_PATTERN_SHAPES: HeroPatternShape[] = [
  { id: 'dots', labelKey: 'hero_bg_shape_dots', defaultSize: 16, minSize: 8, maxSize: 48 },
  { id: 'grid', labelKey: 'hero_bg_shape_grid', defaultSize: 24, minSize: 8, maxSize: 48 },
  { id: 'diagonal', labelKey: 'hero_bg_shape_diagonal', defaultSize: 24, minSize: 8, maxSize: 48 },
  { id: 'waves', labelKey: 'hero_bg_shape_waves', defaultSize: 24, minSize: 12, maxSize: 48 },
  { id: 'speckle', labelKey: 'hero_bg_shape_speckle', defaultSize: 24, minSize: 12, maxSize: 48 },
  { id: 'offset-dots', labelKey: 'hero_bg_shape_offset_dots', defaultSize: 16, minSize: 8, maxSize: 48 },
  { id: 'checkerboard', labelKey: 'hero_bg_shape_checkerboard', defaultSize: 20, minSize: 8, maxSize: 48 },
  { id: 'rings', labelKey: 'hero_bg_shape_rings', defaultSize: 28, minSize: 12, maxSize: 48 },
  { id: 'zigzag', labelKey: 'hero_bg_shape_zigzag', defaultSize: 20, minSize: 8, maxSize: 48 },
  { id: 'plus', labelKey: 'hero_bg_shape_plus', defaultSize: 24, minSize: 8, maxSize: 48 },
];
...
export function buildPatternBackgroundImage(
  ...
  switch (shapeId) {
    ...
    case 'zigzag':
      return `linear-gradient(135deg, ${a(0.1)} 25%, transparent 25%) 0 0, linear-gradient(225deg, ${a(0.1)} 25%, transparent 25%) 0 0, linear-gradient(315deg, ${a(0.1)} 25%, transparent 25%) 0 0, linear-gradient(45deg, ${a(0.1)} 25%, transparent 25%) 0 0`;
    case 'plus':
...
export function getPatternBackgroundSize(shapeId: string, sizeOverride?: number): string {
  ...
  if (shapeId === 'zigzag') {
    ...
    return `${size}px ${half}px, ${size}px ${half}px, ${size}px ${half}px, ${size}px ${half}px`;
  }
